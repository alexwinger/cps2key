...
FINAL_IMAGE=${DISTDIR}/cps2key.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/cps2key.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC12F675
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/cps2key.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/cps2key.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC12F675 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/cps2key.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
